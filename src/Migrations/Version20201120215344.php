...
final class Version20201120215344 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("INSERT INTO estado (descripcion) VALUES ( 'PENDIENTE'),( 'REALIZADO'),( 'PAGADO'),( 'CANCELADO')");
        ...
        $this->addSql("INSERT INTO tipo_venta (descripcion) VALUES ( 'Comprobante'),( 'Pedido')");
        // this up() migration is auto-generated, please modify it to your needs
